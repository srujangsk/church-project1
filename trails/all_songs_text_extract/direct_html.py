...
def create_html_file(title, content):
    # Create an HTML file in the 'songs_html/' directory with the corresponding title
    file_name = f"songs_html/{title}.html"
...
def process_links_and_titles(links_file, titles_file):
    ...
    # Create a directory named 'songs_html' if it doesn't exist
    output_directory = 'songs_html'
    ...
    for link, title in zip(links, titles):
        ...
        # Create HTML file for each link with the corresponding title in 'songs_html/' directory
